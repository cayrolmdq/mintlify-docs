...
|---------|-----------|------|
| `/expenses`, `/income`, `/shopping-list`, `/budget-goals`, `/coupons`, `/happy-moment`, `/stamps`, `/campaigns`, `/referrals`, `/profile`, `/transactions`, `/bank-accounts/*`, `/phone-validation` | Cliente final | Ver [Clientes](/clientes) |
